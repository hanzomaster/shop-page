            ...
            <div className="w-full  rounded-lg bg-base-100 p-4">
                <div className="flex items-center justify-between">
                    <div className="flex  justify-normal gap-2 sm:gap-4">
                        ...
                        <button className="btn  btn-square btn-ghost btn-sm" onClick={getPrevMonth}>
                        ...
                        <button className="btn btn-square btn-ghost btn-sm" onClick={getNextMonth}>
                            <ChevronRightIcon className="h-5 w-5" />
                        </button>
                    </div>
                    <div>
                        <button
                            className="btn  btn-ghost btn-outline btn-sm normal-case"
                            onClick={addNewEvent}
                        >
                            Add New Event
                        </button>
                ...
                <div className="mt-1 grid grid-cols-7  place-items-center">
                    {allDaysInMonth().map((day, idx) => {
                        return (
                            ...
                            >
                                <p
                                    className={`mx-1 mt-1 inline-block  flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-sm hover:bg-base-300 ${isToday(day) && ' bg-blue-100 dark:bg-blue-400 dark:text-white dark:hover:bg-base-300'} ${isDifferentMonth(day) && ' text-slate-400 dark:text-slate-600'}`}
